...
install("fortawesome:fontawesome");                                                                                    // 71
install("summernote:summernote");                                                                                      // 72
install("mrt:filesaver");                                                                                              // 73
install("chipcastledotcom:jspdf");                                                                                     // 74
install("chipcastledotcom:meteor-jspdf");                                                                              // 75
install("deps");                                                                                                       // 76
...
install("stylus");                                                                                                     // 94
install("session");                                                                                                    // 95
install("ddp-rate-limiter");                                                                                           // 96
install("localstorage");                                                                                               // 97
install("callback-hook");                                                                                              // 98
install("accounts-base", "meteor/accounts-base/client_main.js");                                                       // 99
install("anti:i18n");                                                                                                  // 100
install("sha");                                                                                                        // 101
install("srp");                                                                                                        // 102
install("accounts-password");                                                                                          // 103
install("ian:accounts-ui-bootstrap-3");                                                                                // 104
install("npm-bcrypt");                                                                                                 // 105
install("coffeescript");                                                                                               // 106
install("raix:eventemitter");                                                                                          // 107
install("meteorspark:util");                                                                                           // 108
install("tap:i18n");                                                                                                   // 109
install("amplify");                                                                                                    // 110
install("tap:i18n-ui");                                                                                                // 111
install("tmeasday:presence");                                                                                          // 112
install("webapp");                                                                                                     // 113
